	...
	, attackPathAdd ( false )
{
	...
	//bullet.push_back ( new ippBullet ( 15.0f, 5.0f, 10.0f, "Enemy Bullet" ) );
...
{
	AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, Global::HEIGHT_RESOLUTION - 100, 0 ), 15.0f, "Loop" );
	AddWaypoint ( Vec3D ( 200, Global::HEIGHT_RESOLUTION - 220, 0 ), 15.0f, "Loop" );
...
{
	AddWaypoint ( Vec3D ( 200, Global::HEIGHT_RESOLUTION - 100, 0 ), 15.0f, "Loop" );
	AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, Global::HEIGHT_RESOLUTION - 220, 0 ), 15.0f, "Loop" );
...
void ippEnemy::AddAttackPath ( int pathNo )
{
	...
	case 1:
		...
		AddWaypoint ( Vec3D ( 200, 500, 0 ), 5.0f, "Attack" );
		AddWaypoint ( Vec3D ( 200, 800, 0 ), 5.0f, "Attack" );
		AddWaypoint ( Vec3D ( 200, 900, 0 ), 5.0f, "Exit" );
		break;
	case 2:
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 100, 300, 0 ), 5.0f, "Attack" );
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, 500, 0 ), 5.0f, "Attack" );
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, 800, 0 ), 5.0f, "Attack" );
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, 900, 0 ), 5.0f, "Exit" );
		break;
	case 3:
		AddWaypoint ( Vec3D ( 200, 400, 0 ), 15.0f );
		AddWaypoint ( Vec3D ( 105, 400, 0 ), 15.0f, "Attack" );
		AddWaypoint ( Vec3D ( 200, 400, 0 ), 15.0f, "Attack" );
		AddWaypoint ( Vec3D ( 200, 800, 0 ), 15.0f, "Attack" );
		AddWaypoint ( Vec3D ( 200, 900, 0 ), 15.0f, "Exit" );
		break;
	case 4:
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, 400, 0 ), 15.0f );
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 105, 400, 0 ), 15.0f, "Attack" );
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, 400, 0 ), 15.0f, "Attack" );
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, 800, 0 ), 15.0f, "Attack" );
		AddWaypoint ( Vec3D ( Global::WIDTH_RESOLUTION - 200, 900, 0 ), 15.0f, "Exit" );
		break;
	}
...
void ippEnemy::Update_Movement ()
{
	...
	else if ( waypointList[waypointIndex]->tag.compare( "Attack" ) == 0 )
	{
		moveSpeed = 10.0f;
		turnSpeed = 13.0f;
	}
