...
void ippMissile::Render ( void )
{
	...
	/*glTexCoord2f(tex, 0.0f);*/			glVertex2f ( -(sizeX/2), (sizeY/2) );
		/*glTexCoord2f(texNext, 0.0f);*/	glVertex2f ( -(sizeX/2), -(sizeY/2) );
		/*glTexCoord2f(texNext, 1.0f);*/	glVertex2f ( (sizeX/2), -(sizeY/2) );
		/*glTexCoord2f(tex, 1.0f);*/		glVertex2f ( (sizeX/2), (sizeY/2) );
