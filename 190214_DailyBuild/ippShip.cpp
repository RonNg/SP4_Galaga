...
void ippShip::FireBullet ( void )
{
	...
	weaponList.push_back ( new ippBulletClass ( tempPosition, Vec3D ( 0.0f, -1.0f, 0.0f ), 5.0f, 1, 10.0f, 10.0f ) );
}

void ippShip::OnCollisionEnter ( ippCollider2D* col )
{
	Destroy(col->GetGameObject());
	cout << "SHIP COLLIDE" << endl;
}
