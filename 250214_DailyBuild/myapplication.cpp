...
bool myApplication::Init(void)
{
	...
	*/
	...
	playerShip = new ippShip (Global::WIDTH_RESOLUTION/2, Global::HEIGHT_RESOLUTION - 25, 0.0f, 10.0f, 10.0f );
	playerShip->Init();
...
void myApplication::Update(void) 
{
	...
	{
		playerShip->FireMissile ( new Vec3D ( 400.0f, 400.0f, 0.0f ) );
	}
	...
	cout << ippObjectManager::GetInstance()->GetNumberOfEnemy() << endl;
