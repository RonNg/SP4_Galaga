...
void ippEnemyManager::InitGrid( float xSize, float ySize, int xArray, int yArray, float xShip, float yShip, float xGrid, float yGrid )
{
...
void ippEnemyManager::ChangeLastPoint( int number )
{
	if( resetAt )
	{
		lastPoint = number + 2;
...
Vec3D ippEnemyManager::AssignGridSlot( int num )
{
