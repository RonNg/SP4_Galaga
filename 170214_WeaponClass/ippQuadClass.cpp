...
void ippQuadClass::DrawQuads ()
{
	...
	//Draws the size of the quads according to the length and width
		/*glTexCoord2f(tex, 0.0f);*/		glVertex2f ( qX, qY );
		/*glTexCoord2f(texNext, 0.0f);*/	glVertex2f ( qX + length, qY );
		/*glTexCoord2f(texNext, 1.0f);*/	glVertex2f ( qX + length, qY + width );
		/*glTexCoord2f(tex, 1.0f);*/		glVertex2f ( qX, qY + width );
